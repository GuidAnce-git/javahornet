...
import p2p.githubtest.utils.ExceptionThrowingFunction;
import p2p.githubtest.utils.ExceptionThrowingFutureSupplier;
import p2p.githubtest.utils.ExceptionThrowingRunnable;
import p2p.githubtest.utils.ExceptionThrowingSupplier;
...
public class SafeFuture<T> extends CompletableFuture<T> {
    ...
    public static <U> SafeFuture<Void> allOfFailFast(final SafeFuture<?>... futures) {
        ...
        Stream.of(futures).forEach(future -> future.finish(() -> {
